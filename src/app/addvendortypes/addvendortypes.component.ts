...
@Component({
  selector: 'app-addvendortypes',
  templateUrl: './addvendortypes.component.html',
  styleUrls: ['./addvendortypes.component.css']
})
export class AddvendortypesComponent implements OnInit {

  // multiselect array declarations
  ...
  vendortyperows = [
    { number: '1', type: 'Infrastructure Vendors', status: 'Pending' },
    { number: '2', type: 'Security Vendors', status: 'Pending' },
    { number: '3', type: 'Utilities Vendors', status: 'Approved' },
  ];
  vendortypecolumns = [
    { prop: 'number' },
    { name: 'Type' },
  ...
  //Needed this functions for multiselect to work perfectly
  ...
  addvendortype(){
    var self = this;
    // self.vendortype.name = self.vendortypename;
    axios.post('http://103.214.233.141:3333/v1/secure/vendors/types',{
      "name" : self.vendortypename,
      "status" : "0"
    })
    .then(function (response) {
        console.log(response.data);
        alert("Vendor Type Added Sucessfully");
     })
